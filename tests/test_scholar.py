...
from google_scholar_search_mcp.models import PaperResult
from google_scholar_search_mcp.scholar import ScholarClient
...
@patch("google_scholar_search_mcp.scholar.scholarly")
